...
public class BlueLeft2Pieces extends SequentialCommandGroup {

  public BlueLeft2Pieces(Drivetrain drivetrain, Shooter shooter, Intake intake, IntakeMove intakeMove,
    ...
    super.addCommands(
        ...
        trajectoryBuilder.build(true, "2-forward"),
        new WaitCommand(0.4),
        new CollectOff(intake),
        new IntakeUpToSensor(intakeMove),
        trajectoryBuilder.build(false, "2-reverse"),
        new ShootAutonomous(2, intake, shooter));
  }
}