...
public class BlueRight2Pieces extends SequentialCommandGroup {

  public BlueRight2Pieces(Drivetrain drivetrain, Shooter shooter, Intake intake, IntakeMove intakeMove,
