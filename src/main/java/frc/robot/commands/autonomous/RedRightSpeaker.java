...
public class RedRightSpeaker extends SequentialCommandGroup {
  // Max Acceleration = 1.1 Max Velocity = 1.1
  public RedRightSpeaker(Drivetrain drivetrain, Shooter shooter, ShooterTest shooterTest, Intake intake, IntakeMove intakeMove,
